        ...
        <div class="row">
            <div class="col-lg-8 pb-5">
                <div class="course-details-content-wrap pt-90px">
                            ...
                            <div class="media media-card">
                                <div class="instructor-img">
                                    <a href="teacher-detail.html" class="media-img d-block">
                                        <img class="lazy" src="{{ (!empty($course->user->photo)) ? url('upload/instructor_images/' . $course->user->photo) : url('upload/no_image.jpg') }}" data-src="{{ (!empty($course->user->photo)) ? url('upload/instructor_images/' . $course->user->photo) : url('upload/no_image.jpg') }}" alt="Avatar image">
                                    </a>
                                            ...
                                            <div class="review-bars d-flex align-items-center mb-2">
                                                ...
                                                <div class="review-bars__fill">
                                                    <div class="skillbar-box">
                                                        <div class="skillbar" data-percent="{{ round($ratingInfo['percent'], 1) }}%">
                                                            <div class="skillbar-bar bg-3" style="width: {{ $ratingInfo['percent'] }}"></div>
                                                        </div> <!-- End Skill Bar -->
                                                    </div>
                                                </div><!-- end review-bars__fill -->
                                                <div class="review-bars__percent">{{ round($ratingInfo['percent'], 1) }}%</div>
                                            </div><!-- end review-bars -->
                                        @endforeach
                                    @else
                        ...
                        <div class="review-wrap">
                            ...
                            <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                <div class="media-img mr-4 rounded-full">
                                    <img class="rounded-full lazy" src="{{ (!empty($item->user->photo)) ? url('upload/user_images/' . $item->user->photo) : url('upload/no_image.jpg') }}" data-src="{{ (!empty($item->user->photo)) ? url('upload/user_images/' . $item->user->photo) : url('upload/no_image.jpg') }}" alt="User image">
                                </div>
                                <div class="media-body">
                    ...
                    @guest
                        <p><b>For add a Course Review. You need to login first <a href="{{ route('login') }}">Login Here</a></b></p>
                    @else
                        <div class="course-overview-card pt-4">
                            ...
                            <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                ...
                                <div class="media-body">
                                    ...
                                    @if ($related->discount_price == NULL)
                                        <p class="card-price text-black font-weight-bold">Rp{{ $related->selling_price }}</p>
                                    @else
                                        <p class="card-price text-black font-weight-bold">Rp{{  $related->discount_price }} <span class="before-price font-weight-medium">Rp{{ $related->selling_price }}</span></p>
                                    @endif
                                </div>
                            </div><!-- end media -->
                            @endforeach

                ...
                $.each(response.carts, function(key,value){
                    miniCart += `<li class="media media-card">
                            ...
                            <div class="media-body">
                                ...
                                <a type="submit" id="${value.rowId}" onclick="miniCartRemove(this.id)"><i class="la la-trash"></i> </a>
                            </div>
                        </li>
                        `
                });
                    ...
                    $('#couponCalField').html(
                        ...
                        <ul class="generic-list-item pb-4">
                            ...
                            <li class="d-flex align-items-center justify-content-between font-weight-semi-bold">
                                ...
                                <span>${data.coupon_name} <button type="button" class="icon-element icon-element-xs shadow-sm border-0" data-toggle="tooltip" data-placement="top" onclick="couponRemove()"><i class="la la-trash"></i></button></span>
                            </li>
                            <li class="d-flex align-items-center justify-content-between font-weight-semi-bold">

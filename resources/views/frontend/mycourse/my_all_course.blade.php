    ...
    <div class="dashboard-cards mb-5">
        ...
        <div class="card card-item card-item-list-layout">
            ...
            <div class="card-body">
                ...
                <p class="card-text"><a href="{{ route('course.view', $item->course_id) }}">{{ $item->course->user->name }}</a></p>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <p class="card-price text-black font-weight-bold">Rp{{ $item->course->selling_price }}</p>

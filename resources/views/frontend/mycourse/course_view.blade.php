        ...
        <div class="container-fluid">
            <div class="main-menu-content d-flex align-items-center">
                ...
                <div class="course-dashboard-header-title pl-4">
                    <a href="{{ url('course/details/' . $course->course->id . '/' . $course->course->course_name_slug) }}" class="text-white fs-15">{{ $course->course->course_name }}</a>
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <div class="question-meta-content">
                                                                <a href="javascript:void(0)" class="d-block">
                                                                    <h5 class="fs-16 pb-1">Subject : {{ $que->subject }}</h5>

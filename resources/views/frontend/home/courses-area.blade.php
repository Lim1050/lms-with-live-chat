    ...
    <div class="container">
        ...
        <ul class="nav nav-tabs generic-tab justify-content-center pb-4" id="myTab" role="tablist">
            ...
            @foreach ($categories as $category)
                <li class="nav-item">
                    <a class="nav-link" id="business-tab" data-toggle="tab" href="#business{{ $category->id }}" role="tab" aria-controls="business" aria-selected="true">{{ $category->category_name }}</a>
                </li>
            @endforeach
        </ul>

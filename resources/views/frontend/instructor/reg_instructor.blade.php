                        ...
                        <form method="post" action="{{ route('instructor.register') }}" class="row">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    @error('username')
                                        is-invalid
                                    @enderror" type="text" name="username" placeholder="username">
                                    <span class="la la-user input-icon"></span>
                                    @error('username')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    @error('email')
                                        is-invalid
                                    @enderror" type="email" name="email" placeholder="email@email.com">
                                    <span class="la la-user input-icon"></span>
                                    @error('email')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    @error('phone')
                                        is-invalid
                                    @enderror" type="text" name="phone" placeholder="628123456789">
                                    <span class="la la-user input-icon"></span>
                                    @error('phone')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    @error('address')
                                        is-invalid
                                    @enderror" type="text" name="address" placeholder="Jl. mana aja">
                                    <span class="la la-user input-icon"></span>
                                    @error('address')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror

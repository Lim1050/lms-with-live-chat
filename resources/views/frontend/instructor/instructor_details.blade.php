        ...
        <div class="breadcrumb-content">
            <div class="media media-card align-items-center pb-4">
                ...
                <div class="media-body">
                    ...
                    <span class="d-block lh-18 pt-1 pb-2">{{ Carbon\Carbon::parse($instructor->created_at)->diffForHumans() }}</span>
...
<div class="tooltip_templates">
    <div id="tooltip_content_1{{ $item->id }}">
        <div class="card card-item">
            <div class="card-body">
                <p class="card-text pb-2">By <a href="{{ route('instructor.details', $item->instructor_id) }}">{{ $item['user']['name'] }}</a></p>
                ...
                <div class="d-flex align-items-center pb-1">
                    ...
                    <p class="text-success fs-14 font-weight-medium">Updated<span class="font-weight-bold pl-1">{{ $item->created_at->format('d M Y') }}</span></p>
                    </div>
                </div>

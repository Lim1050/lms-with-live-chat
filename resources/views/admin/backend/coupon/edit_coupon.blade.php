...
<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    ...
                    <div class="ms-auto">
                        <div class="btn-group">
                            <a href="{{ route('admin.all.coupon') }}" class="btn btn-primary px-5">Back</a>
                        </div>
					</div>
				</div>
				<!--end breadcrumb-->
                    ...
                    <div class="card-body p-4">
                        ...
                        <form id="myForm" action="{{ route('admin.update.coupon') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="coupon_discount" class="form-control" id="input1" value="{{ $coupon->coupon_discount }}">
                            </div>
